...
# Monkey-patch to bypass dtype check for tree node arrays
from sklearn.tree._tree import Tree
def _check_node_ndarray(self, nodes):
    return nodes
Tree._check_node_ndarray = _check_node_ndarray
...
def load_model():
    try:
        print("📦 Caricamento del modello iniziato...")
...
try:
    print("📊 Tentativo di predizione iniziato...")
